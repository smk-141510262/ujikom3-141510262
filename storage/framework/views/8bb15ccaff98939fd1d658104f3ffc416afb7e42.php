                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li>
                                    <a href="<?php echo e(url('/KategoriLembur')); ?>">Kategori Lembur</a>
                                    <a class="active" href="<?php echo e(url('/LemburPegawai')); ?>">Lembur Pegawai</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li>
                                    ...
                                    <a class="active" href="<?php echo e(url('/TunjanganPegawai')); ?>">Tunjangan Pegawai</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
