        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <a href="{{url('/Pegawai')}}" class="btn btn-success btn-block">Kembali</a><br>
                    <center><img src="{{asset('gambar/'.$pegawais->photo.'')}}" width="250" height="250" class="img-circle img-responsive" alt="Responsive image"></center><br>
                    <label>NIP</label>
                    ...
                    <label>Jabatan</label>
                    <input type="text" name="jabatan_id" placeholder="{{$pegawais->JabatanModel->nama_jabatan}}" class="form-control" disabled><br>
                    <label>Golongan</label>
                    <input type="text" name="golongan_id" placeholder="{{$pegawais->GolonganModel->nama_golongan}}" class="form-control" disabled><br>
